...
export class OrderHistoryPage {
  ...
  openOrderDetailPage(orderid:String, fname:String, lname:String, area:String, address:String, mobile:String, couponprice:String, shipping:String, total:String, ordertime:String) {
