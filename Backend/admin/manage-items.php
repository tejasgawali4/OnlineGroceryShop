...
if(isset($_REQUEST['unoffer']))
{
$aeid=intval($_GET['unoffer']);
$status='YES';
$sql = "UPDATE items SET offer=:status WHERE  id=:aeid";
$query = $dbh->prepare($sql);
$query -> bindParam(':status',$status, PDO::PARAM_STR);
$query-> bindParam(':aeid',$aeid, PDO::PARAM_STR);
$query -> execute();
...
{				?>	
                      <tr>
                        ...
                        <td>
                          <img src="itemimg/<?php echo htmlentities($result->image);?>" style="width:50px;"/>
                        </td>
                        <td>
                        ...
                        <td>
                          ...
                          <?php echo htmlentities($result->quantitytype);?>
                        </td>
                        <td>
...
{?>
                        ...
                        <td>
                          <?php if($result->offer == 'YES')
{?>
                          <a href="manage-items.php?offer=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Remove item from Offers')">YES
                          </a> 
                          <?php } else {?>
                          <a href="manage-items.php?unoffer=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Make item on Offers Page')">NO
                          </a>
                          <?php } ?>
                        </td>									
                        <td>
                        <a href="update-item.php?edititem=<?php echo $result->id;?>" onclick="return confirm('Do you want to update Item');">&nbsp; 
