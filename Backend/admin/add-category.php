...
$sql="INSERT INTO  category(categry, catedes, cateimg) VALUES(:categry, :catedes, :cateimg)";
                      ...
                      <form enctype="multipart/form-data" method="post" class="form-horizontal" onSubmit="return valid();">
                        ...
                        <div class="succWrap">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" name="catedes"  required>
                            </div>
                          </div>
                          <div class="form-group">
