...
$sql="INSERT INTO items(name, category, description, price, mrp, quantity, quantitytype, image) VALUES(:name, :category, :description, :price, :mrp, :itemqtn, :itemqtntype, :images)";
...
if($lastInsertId)
{
  $sql="INSERT INTO itemimages(img, itemid) VALUES(:img, :id)";
  $query = $dbh->prepare($sql);
  $query->bindParam(':img',$itemimg,PDO::PARAM_STR);
...
{				?>	
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <textarea class="form-control" name="itemdes" rows="5">
                            </textarea>
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label class="col-sm-2 control-label">Your Price
                            <span style="color:red">*
                            </span>
                          </label>
                          <div class="col-sm-4">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <input type="number" name="itemmrp" class="form-control" step="0.01" required>
                          </div>
                        </div>
